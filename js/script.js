...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var UNITS = {
    ...
    c: [
      ...
      { code: "C12", title: "Dep. C12", tag: "Dúplex + Terraza", area: "Consultar", status: "disponible", dorm: "2 dormitorios", banos: "2 baños", extra: "Terraza 22.64 m²", ficha: "img/fichas/C12.jpg", thumb: "img/fichas/thumbs/C12.jpg" }
    ]
  };

  function unitCardHTML(u) {
    var statusLabel = u.status === "vendido" ? "Vendido" : "Disponible";
